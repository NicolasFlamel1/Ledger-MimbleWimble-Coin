...
Requires user interaction: No
Example request: C70600006500000000010000000000000008E096C8D9A95570297DFA520BC4F175399CB76672A590A50D5ABA6CD438AD02F4657A656A33636A746B6D6576687079617969676F326370623537747534677174676B6933727066757A6D726E6C6272333574653365626164
...
Response: Ed25519 signature (64 bytes)
Requires user interaction: Yes
Example request: C7070000500000000001040006E63101832D7A85EBF60242BD50C80EAE7760789288F8041E22C1954604037B42D7B564010020040026489D8933530953BF00C20CED09E1EFE74E1A133291B8BCB4CB22D5863BECC9
...
Requires user interaction: No
Example request: C708000024000000009F28E8FA945FF3E7111AEF63C4396823F65F46D853F39AE36E9501301814494C
...
Response: N/A
Requires user interaction: No
Example request: C70B000030000000009F28E8FA945FF3E7111AEF63C4396823F65F46D853F39AE36E9501301814494C86F3A5F7512FBA489B4D04DF
...
Requires user interaction: No
Example request: C70C000040CD475B638924CDD7AC822ABA96A6E559D9FF39D84680D2C93AC61FC23B5AE28366ACD619C0A16296ED156F3D98B2E440B3B6FB88B162C1219ED5C009554A74C8
...
Requires user interaction: No
Example request: C70D0000100B3BE8125B4081F33E7EB62A43C41A26
...
Response: Compressed secp256k1 public key (33 bytes)
Requires user interaction: No
Example request: C70E00000400000000
...
Requires user interaction: No
Example request: C70F00006100000000010000000000000008E096C8D9A95570297DFA520BC4F175399CB76672A590A50D5ABA6CD438AD02F4786D6A434A574B504C6265344470723156346B72446E776B327735484D42734667337942736538795255597946614C70534C4852
...
Requires user interaction: No
Example request: C7100000250000000003D8E38A4968916176410BE0C7FB96CA4B03B17A43EA98008071A6EFA4DEAFF4F5
...
Response: Encrypted data (same size as the data)
Requires user interaction: No
Example request: C71100004000010203040506070809000102030405060708090001020304050607080900010203040506070809000102030405060708090001020304050607080900010203
...
Response: N/A
Requires user interaction: No
Example request: C7130000390000000003D8E38A4968916176410BE0C7FB96CA4B03B17A43EA98008071A6EFA4DEAFF4F5FFEC82955929F30286F3A5F7512FBA489B4D04DF
Example response: N/A
```
...
Response: Decrypted data (size of the data ceil to the next 16 byte boundary)
Requires user interaction: No
Example request: C7140000404C299DF0C501B7C78E961788C7BB35773B81E5D9820F2D6437074B24CF0F100CF8A16E7F0EA077308F22A9F1C63C44EA089D8171A846DBB2712EE69B0CA7DEBF
Example response: 5E8C5D613CF500995FB6B03E0A8B266D89D18DDD8672593BE0179B3B88020D05A96A74ED39366613831007729FCC398775B89DEB42A8569067FBCA3C2FE60FC7A823F99A54D4C9E9A3D84D0B16D1A432
```
...
Response: AES key (16 bytes)
Requires user interaction: No
Example request: C7150000108DE95463C9B23A107D18BA3DDE480E61
Example response: 000102030405060708090A0B0C0D0E0F
```
...
Response: N/A
Requires user interaction: No
Example request: C71600001C00000000020000000000000001000000000000000300000000000000
Example response: N/A
```
...
Response: N/A
Requires user interaction: No
Example request: C71700001A0300000001000000000000000000000000020000000000000001
Example response: N/A
```
...
Response: N/A
Requires user interaction: No
Example request: C71800001A0300000002000000000000000000000000040000000000000001
Example response: N/A
```
...
Response: N/A
Requires user interaction: No
Example request: C71900002008E096C8D9A95570297DFA520BC4F175399CB76672A590A50D5ABA6CD438AD02
Example response: N/A
```
...
Example request: C71B00002203C1AA1FE1698AC85C309B0F80A367AF56AFA0F3AA09E40E4C10CDF32E73E7338201
