...
* The `Get bulletproof components` command takes about 90 seconds to complete on a Ledger Nano S hardware wallet, about 46 seconds to complete on a Ledger Nano X hardware wallet, and about 24 seconds to complete on a Ledger Nano S Plus hardware wallet.
